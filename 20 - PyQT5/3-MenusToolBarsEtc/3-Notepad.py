"""
QInputDialog    Native dialog box in PyQt that can be used to receive input from the
                user. The input is a single value that can be a string, a number, or an 
                item from a list.

QFontDialog     provides a dialog box that allows the user to select and manipulate
                different types of fonts. To create a font dialog box and choose a font, 
                use the getFont() method.

QColorDialog    creates a dialog box for selecting colors  Selecting colors can be useful 
...
class Notepad(QMainWindow):
    ...
    def aboutDialog(self):
        ...
        "Beginner's Practical uide to PyQt\n\nProject 5.1 - Notepad GUI")
