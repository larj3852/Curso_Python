...
"""
QFormLayout     It is a layout class that arranges its children widgets into a two-column layout, 
                the left column consisting of labels and the right one consisting of entry field 
                widgets such as QLineEdit or QSpinBox. The QFormLayout class makes designing these 
                kinds of GUIs very convenient.
"""
...
class GetApptForm(QWidget):
    ...
    def initializeUI(self):
        ...
        """
        self.setGeometry(200, 250, 300, 400)
