"""
QGridLayout      is used to arrange widgets in rows and columns similar to a spreadsheet or matrix. 
                The layout manager takes the space within its parent window or widget and divides 
                it up according to the sizes of the widgets within that row (or column). 
                Adding space between widgets, creating a border, or stretching widgets across 
...
class ToDoList(QWidget):
    ...
    def setupWidgets(self):
        ...
        todo_title.setFont(QFont('Arial',28))
        ...
        mustdo_grid.setContentsMargins(5, 5, 5, 5)      #Los Margin Bottons Pues
        ...
        main_grid.addWidget(todo_title, 0, 0, 1, 2) #Fila Orig, Columna, Orig, Heigth Filas, Width Columnas
