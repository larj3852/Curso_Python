# notepad.py IMPORTANTE QFileDialog implementacion en linea 54
...
class Notepad(QWidget):
    ...
    def clearText(self):
        ...
        "Do you want to clear the text?", QMessageBox.No | QMessageBox.Yes, QMessageBox.Yes)
    ...
    def saveText(self):
        ...
        """
        options = QFileDialog.Options() #AQUI AQUI AQUI AQUI
